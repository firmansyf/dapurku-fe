            ...
            return (
                <Form>
                    <div className="flex gap-7">
                        ...
                        <div className="w-1/3 flex flex-col gap-6 items-center justify-start relative">
                            <div {...getRootProps()} className="relative w-[70%] h-[50%] border-2 border-dashed rounded-full cursor-pointer p-2">
                                <input {...getInputProps()} />
                                <img
